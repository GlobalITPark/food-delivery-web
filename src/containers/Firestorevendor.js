          ...
          <NavBar 
            ...
            <div style={{ float: 'right', 'margin-top' : '-40px', 'margin-right' : '28px', 'padding-top' : '8px'}}>
              {name === 'restaurant_collection' ?
                <a className="btn btn-primary" onClick={()=>this.viewCreateRestaurantDialog()}>Add New Resturant/新しいレストランの追加</a>
                :
                ""
              }
              {name === 'restaurant' ?
                <a className="btn btn-primary" onClick={()=>this.viewCreateMenuDialog()}>Add New Menu Item/メニューの追加</a>
                :
                ""
              }
            </div>
