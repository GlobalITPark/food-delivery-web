...
"fieldsTypes":{
  ...
  "textarea":["description", "description_ja"],
  "html":["content"],
  "radio":["radio","radiotf","featured","isShopping","showPhotos","layout","coloring","outbound","rounded","sectionType","showNavButton", "isActive"],
  "checkbox":["checkbox"],
  "dropdowns":["type",'foodStatus',"reservationStatus","status","dropdowns","navButtonAction", "isNews"],
  "file":["videoField"],
  "rgbaColor":['rgba'],
...
"optionsForSelect":[
    ...
    {"key":"foodStatus","options":["just_created", "confirmed", "rejected", "ready_to_pick", "picked_up", "canceled",  "out_for_delivery","delivered","cannot_deliver"]},
    {"key":"reservationStatus","options":[ "confirmed", "canceled", "rejected"]},
    ...
    {"key":"isActive","options":["true","false"]},
