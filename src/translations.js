const availableLangs = {
  'en' : {
    ...
    "Delivery/ Pickup Time" : "Delivery/ Pickup Time",
  ...
  'jp' : {
    ...
    "dayOfWeek" : "曜日",
    "editItem" : "メニュー項目の編集",
    "areYouSureYouWantToDeleteThisItem" : "このアイテムを削除してもよろしいですか？",
    "addToOrder" : "注文に追加",
    "addNewMenuItem" : "新しいメニュー項目を追加する",
    "reasonForReject" : "拒否の理由",
    "specialInstructions" : "特別な指示",
    "changeOrderStatus" : "注文ステータスの変更",
    "optionalMessage" : "オプションのメッセージ",
    "expectedDeliveryTime" : "配達予定時間",
    "currentStatus" : "注文ステータスの変更",
    "viewOrder" : "表示の順序",
    "viewOnMap" : "地図で見る",
    "deliveryLocation" : "お届け場所名",
    "pointsRedeemed" : "交換ポイント",
    "amountPayable" : "お支払い可能な金額",
    "success" : "成功",
    "currentStatus" : "現在の状態",
    "orderDetails" : "注文詳細",
    "orderNo" : "注文番号",
    "Delivery/ Pickup Time" : "配達/集荷時間",
    "Name of the customer" : "顧客名",
    "Phone Number" : "注文者　電話番号",
    "Order type" : "注文タイプ",
    "Delivery Instructions" : "配達指示書",
    "Address" : "住所",
    "orderItems" : "ご注文商品",
    "foodName" : "食品名",
    "qty" : "数量",
    "variant" : "バリアント",
    "deliveryCharge" : "配達料",
    "deliveredSuccessfully" : "正常に配信されました",
